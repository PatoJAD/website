(function (exports) {
     ...
     * License : GPLv3
     * Version : 1.5.1
     * Author : PatoJAD <joaquin.decima@gmail.com>
     */
    ...
    let createElements = (parameters, countdown) => {
        ...
        if (!parameters.inline) {
            return {
                days: createCountdownElt(countdown, parameters, 'lynx-days-section'),
                hours: createCountdownElt(countdown, parameters, 'lynx-hours-section'),
                minutes: createCountdownElt(countdown, parameters, 'lynx-minutes-section'),
                seconds: createCountdownElt(countdown, parameters, 'lynx-seconds-section')
            };
        }
    ...
    /**
     * lynxCountdown, create and display the coundtown.
     * @param elt
     * @param args (parameters)
     */
    exports.lynxCountdown = (elt, args) => {
        let parameters = extend({
            ...
            refresh: 1000,
            inlineClass: 'lynx-countdown-inline',
            sectionClass: 'lynx-section',
            amountClass: 'lynx-amount',
            wordClass: 'lynx-word',
            zeroPad: false,
            countUp: false
        }, args);
